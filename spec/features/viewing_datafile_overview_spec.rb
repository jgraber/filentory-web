...
feature "Viewing the Datafile overview" do
  ...
  scenario "The size of all files is shown" do
    ...
    expect(page).to have_selector("table tbody tr:nth-of-type(2) td:nth-of-type(2)", text: "#{size} Bytes") # second row, second column
  end
  ...
  scenario "The minimum size of all files is shown" do
    ...
    expect(page).to have_selector("table tbody tr:nth-of-type(3) td:nth-of-type(2)", text: "#{minimumSize} Bytes") # third row, second column
  end
  ...
  scenario "The maximum size of all files is shown" do
    ...
    expect(page).to have_selector("table tbody tr:nth-of-type(4) td:nth-of-type(2)", text: "#{maximumSize} Bytes") # forth row, second column
  end
  ...
  scenario "The average size of all files is shown" do
    ...
    expect(page).to have_selector("table tbody tr:nth-of-type(5) td:nth-of-type(2)", text: "#{averageSize} Bytes") # fifth row, second column
  end
end
